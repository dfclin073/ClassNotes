...
get-childitem C:\Windows\ | sort -property lastwritetime
get-childitem C:\windows\temp | sort -property lastwritetime
get-childitem C:\Windows\system32 | sort -property lastwritetime
write-host ""
...
get-childitem C:\Windows\system32\winevt\logs | sort -property lastwritetime
write-host ""
